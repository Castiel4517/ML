...
final_auc = metrics.roc_auc_score(test_y, final_pred)
final_acc = metrics.accuracy_score(test_y, (final_pred >= 0.5).astype(int))
final_f1 = metrics.f1_score(test_y, (final_pred >= 0.5).astype(int))
